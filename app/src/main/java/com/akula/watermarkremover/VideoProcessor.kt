...
object VideoProcessor {
    ...
    private fun expandRepairRect(
        ...
        // OCR-рамка уже имеет запас. Второе большое расширение раньше превращало
    ...
    private fun toSafeVideoRect(
        ...
        val boxW = right - left
        val boxH = bottom - top
        // Небольшой запас закрывает ореол букв, но не захватывает большой кусок фона.
